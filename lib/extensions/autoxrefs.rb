...
Benchmark.bm do |bm|
  bm.report('Autoxrefs - Scanning Source Files') do
...
Benchmark.bm do |bm|
  bm.report('Autoxrefs - Pushing nested includes') do
...
Benchmark.bm do |bm|
  bm.report('Autoxrefs - For each main include, store a target link') do
...
Benchmark.bm do |bm|
  bm.report('Autoxrefs - Overriding Anchors') do
...
Benchmark.bm do |bm|
  bm.report('Autoxrefs - Point include to parent') do
...
Benchmark.bm do |bm|
  bm.report('Autoxrefs - tempanchors') do
...
Benchmark.bm do |bm|
  bm.report('Autoxrefs - Create a final array of fixes') do
