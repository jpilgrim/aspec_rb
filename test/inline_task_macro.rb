...
class TestInlineTaskMacroProcessor < Test::Unit::TestCase
  ...
  def test_inline_github_pattern
    input = ":task_def_GH-: GitHub;OPR GitHub Issues;https://github.myorg.eu/myorg/onlinepresence/issues/{TASK_ID};images/icons/github.png;GH-{TASK_ID} \ntask:GH-123[]"

    assert_equal("<div class=\"paragraph\">\n<p><a href=\"https://github.myorg.eu/myorg/onlinepresence/issues/GH-123\"><span class=\"label label-default\">GH-123</span></a></p>\n</div>",
                 Asciidoctor::Document.new(input).render)
  end

  def test_inline_jira_pattern
    input = ":task_def_DM-: Jira;DataModel Backlog;https://jira.myorg.eu/browse/DM-{TASK_ID};images/icons/jira.png;DM-{TASK_ID}\ntask:DM-123[]"

    assert_equal("<div class=\"paragraph\">\n<p><a href=\"https://jira.myorg.eu/browse/DM-123\"><span class=\"label label-default\">DM-123</span></a></p>\n</div>",
                 Asciidoctor::Document.new(input).render)
  end
end
